                              ...
                              <div class="card-body pt-0">
                                <div class="row">
                                  <div class="col-8">
                                    ...
                                    <p class="text-muted text-sm"><b>usuario: </b>${usuario.adicional}</p>
                                    <ul class="ml-4 mb-0 fa-ul text-muted">
                                      <li class="small"><span ></span> C.I: ${usuario.dni}</li>
                                      <li class="small"><span ></span> Edad: ${usuario.edad}</li>
                                      <li class="small"><span ></span> Residencia: ${usuario.residencia}</li>
                                      <li class="small"><span ></span> Telefono: ${usuario.telefono}</li>
                                      <li class="small"><span ></span> Correo: ${usuario.correo}</li>
                                      <li class="small"><span ></span> Sexo: ${usuario.sexo}</li>
                                    </ul>
                                  </div>
                                  <div class="col-5 text-center">
                                    <img src="${usuario.avatar}" alt="" class=" img-fluid">
                                  </div>
                                </div>
                              </div>
